    ...
    def projection(self, rnn_outputs):
        ...
        with tf.variable_scope('Projection'):
            ...
            with tf.variable_scope('label'):
                U2 = self.weight_variable('Matrix_label', [self.config.mRNN._hidden_size, self.config.data_sets._len_labels])
                proj_b2 = self.weight_variable('Bias_label', [self.config.data_sets._len_labels])
