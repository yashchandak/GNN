...
def ptb_iterator(raw_data, batch_size, num_steps,shuffle,label, features):
    ...
    for i in range(epoch_size):
        ...
        #converts batch*num_step into batch*num_step*feature_len
        #Decrement values by 1 to get correct mapping
        x = [[features[item-1] for item in row] for row in x]
        y = [[features[item-1] for item in row] for row in y]
